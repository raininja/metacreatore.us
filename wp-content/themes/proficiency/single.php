        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="proficiency-blog-post-box"> <a href="#" class="proficiency-blog-thumb">
		      ...
		      <?php } ?>
          <div class="col-md-12">
            <div class="media proficiency-info-author-block"> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) );?>" class="proficiency-author-pic"> <?php echo get_avatar( get_the_author_meta( 'ID') , 150); ?> </a>
              <div class="media-body">
                <h4 class="media-heading"><span><i class="fa fa-user"></i><?php _e('By','proficiency'); ?></span><a href "<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) );?>"><?php the_author(); ?></a></h4>
